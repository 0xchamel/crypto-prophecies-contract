...
import { ProphetV1Contract, ProphetV2Contract, TCPContract, TokenVestingContract } from '../types/contracts';
...
const nft: ProphetV1Contract = artifacts.require('ProphetV1');
